        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result) {
                    ...
                    parent_item.find('.catalog-item__bottom__prices').html($(div).find('.catalog-item__bottom__prices').html());
